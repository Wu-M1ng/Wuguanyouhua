(() => {
    ...
    const SELECTORS = Object.freeze({
        ...
        seamlessHijackCheckbox: '#my-topbar-test-seamless-hijack',
    ...
    function loadSettings() {
        ...
        if (typeof settings.seamlessHijack !== 'boolean') {
            settings.seamlessHijack = DEFAULT_SETTINGS.seamlessHijack;
        }
    ...
    async function handleReplyResult(options) {
        ...
        const settings = loadSettings();
        const isSeamless = (source === 'auto' && settings.seamlessHijack);

        if (isSeamless || shouldSkipReplyConfirm()) {
    ...
    function handleSeamlessHijackCheckboxChanged() {
        const settings = loadSettings();
        settings.seamlessHijack = $(SELECTORS.seamlessHijackCheckbox).is(':checked');
        savePluginSettings();
    }
    ...
    function syncUiFromSettings() {
        ...
        $(SELECTORS.seamlessHijackCheckbox).prop('checked', settings.seamlessHijack);
    ...
    function bindEvents() {
        ...
        $(document)
            ...
            .off('change.myTopbarTestSeamlessHijack', SELECTORS.seamlessHijackCheckbox)
            .on('change.myTopbarTestSeamlessHijack', SELECTORS.seamlessHijackCheckbox, function () {
                handleSeamlessHijackCheckboxChanged();
            });
